<script type="text/javascript">
    ...
    function s_soal(){        
        $("#uploadform").on('submit',(function(e){
            e.preventDefault();
            $.ajax({
              url:"<?php echo site_url('Soal_Controller/edit_soal');?>",
              type:"POST",
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>Soal</label>
                                                <input type="hidden" name="id_soal" value="<?php echo $hsl['id_soal'];?>">
                                    ...
                                    <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="kunci" id="kunci">
                                                    ...
                                                    <option <?php if($hsl['kunci']=="E"){echo "selected";}?>>E</option> 
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Kelas</label>
